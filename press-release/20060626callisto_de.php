...
<div id="maincontent">
	<div id="midcolumn">
		...
		<p><strong>OTTAWA, KANADA – 26. Juni 2006 </strong>– Die Eclipse Foundation kündigte heute das 
		gleichzeitigen Release von zehn Eclipse Open-Source-Projekten an. Dieses besondere Release-Ereignis namens 
		Callisto ist eines der größten Multi-Projekt-Releases, das je eine Open-Source-Community unternommen hat. 
		Die Eclipse Foundation bietet mit „Callisto“ die synchrone Einführung von zehn Einzelprojekten, die 
		Anwendern, vor allem auch Einsteigern, die Einführung von offenen Werkzeugen erleichtern. Die 
		Veröffentlichung von Callisto kennzeichnet das dritte Jahr in Folge, in dem Eclipse ein großen Release 
		innerhalb des vorgegebenen Zeitplans ausgeliefert hat. Die Projekte aus dem Callisto-Release stehen ab dem 
		30. Juni 2006 zum Download unter <a href="http://www.eclipse.org">www.eclipse.org/callisto</a> bereit.  </p>

		<p>Callisto stellte ein voluminöses Vorhaben für die Eclipse-Community  mit 10 verschiedenen Projektteams, 
		260 Beteiligten und über 7 Millionen Codezeilen dar. 15 verschiedene unabhängige Software-Anbieter (ISVs) 
		stellen Open-Source-Entwickler ab, um an den in Callisto enthaltenen Projekten zu arbeiten und 
		demonstrierten damit die von zahlreichen Anbietern unterstützte  globale Natur der Eclipse-Community. 
		Diese Entwickler arbeiten  in 12 verschiedenen Ländern weltweit: Kanada, USA, Finnland, Türkei, China, 
		Frankreich, Russland, Tschechien, Indien, Schweiz, Deutschland und Österreich.  </p>
		...
		„Als wir das Callisto-Release im letzten Jahr zum ersten Mal starteten, stellte dieser Versuch, so viele 
		Projekte zu kombinieren, ein Risiko dar. Heute haben die Eclipse-Projekte bewiesen, dass eine verteilte 
		Community, die gemeinsam an mehreren Projekten arbeitet und an der zahlreiche Anbieter beteiligt sind, sehr 
		effektiv  Software innerhalb eines vorhersehbaren Zeitplans auszuliefern kann.“</p>

		<p>Ein wichtiges Anliegen von Callisto ist es, Unternehmen wie etwa ISVs oder Enterprise-Entwicklern zu 
		ermöglichen, Eclipse als Plattform für die Anwendungsentwicklung einfacher zu adaptieren. Die Benutzer 
		...
		verschiedener Projekte dar, die ihre eigene Planung und Roadmap beibehalten, diese jedoch mit den anderen 
		Projekten abgestimmt haben. Zu den ISVs, die planen, Projekte aus dem Callisto-Release zu nutzen, 
		gehören z. B. Actuate, AvantSoft, BEA, Borland, Business Objects, IBM, ILOG, Innoopract, Intalio, 
		Intervoice, Klocwork, Lattix, LogicLibrary, Lombardi, Lynxworks, Oracle, QNX und Scapa Technologies.</p>
		...
		<p>Einige der Technologie-Highlights der Projekt-Releases sind unter anderem:
			...
			OSGi-Laufzeitumgebung, Teil des Eclipse Equinox-Projekts, bildet die Grundlage der Eclipse Rich 
			Client Platform (RCP). Als Standalone-Framework wird sie von den Entwicklern in den unterschiedlichsten 
			Anwendungsarchitekturen eingesetzt , unter anderem für Embedded-, Client- und Server-Anwendungen.</p>
			...
			laufen. </p>
 			...
 			<li><p><strong>Release 1.0 von DTP und GMF:</strong>Die Data Tools Platform (DTP) stellt die Frameworks 
 			für die Erstellung datenzentrischer Anwendungen bereit. Das Graphical Modeling Framework erleichtet die 
 			Erstellung von , Anwendungen , die grafische Editoren beinhalten.</p>
			</ul>
			</p>
