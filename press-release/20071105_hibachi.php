...
<div id="maincontent">
	<div id="midcolumn">
		...
		<h2>Press Release</h2>
		<p><strong>SIGAda Conference, Fairfax, VA - November 5, 2007 </strong> - The Eclipse Foundation today announced the creation of a new open-source project called Hibachi. <a href="http://www.eclipse.org/hibachi/">The Hibachi project</a> provides an industrial-strength, vendor-neutral Ada integrated development environment (IDE) that also serves as a platform for other contributors to provide value-added functionality for Ada developers. Hibachi is a sub-project of the Eclipse Tools Project, and it parallels and complements CDT, the C/C++ Development Tooling project, providing a multi-language native embedded software development environment. The name Hibachi is an anagram honoring the late Jean Ichbiah, lead designer of the Ada language.</p>  
