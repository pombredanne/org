...
<div id="maincontent">
	<div id="midcolumn">
		...
		member companies are also announcing a variety of exciting new initiatives at this year&#146;s conference, including:
			...
			Brede and Achim L&ouml;rke will also be available on stand 104 in the exhibition hall.<br>
			...
			<li><b>Etish</b> has recently become an Add-In Provider member of the Eclipse Foundation. Their Open Requirements Management
			...
			<li><b>ILOG</b> introduces Agile Business Rules Development (ABRD) methodology, the industry&#146;s first free, vendor-neutral
			...
			<li><b>Instantiations</b> Instantiations&#146' newly enhanced CodePro AnalytiX Server now offers modern, agile and innovative software analysis
			...
			<li><b>MicroDoc</b> specializes in code quality assurance and integrated development process support for enterprise and
			...
			<li><b>Polarion Software</b> announces its ongoing support for the Subversive Team Provider project, and that it will sponsor a long
			...
			Service, Wire Admin Service and Declarative Services. ProSyst is an OSGi pioneer. The Open Source mBedded Server Equinox
			...
			offering a clean pedigree that ensures accurate use of licenses.<br>
