...
<div id="maincontent">
	<div id="midcolumn">
		...
		<p>“This is a major milestone for the project as open-sourcing the Higgins technology ensures that there will be easy access to it, and that developers can innovate around it. It also means that customers won't be locked into a proprietary architecture when they adopt user-centric identity management systems,” said Anthony Nadalin, IBM Distinguished Engineer and Chief Security Architect.  “The project will extend IBM's identity management portfolio by putting people in the driver's seat of their personal identity information while also giving companies, governments and social networking outlets new ways to collaborate."  </p>
