...
<div id="maincontent">
	<div id="midcolumn">
		...
		<h3>Purpose and Scope</h3>
     	...
     	<p>The SOA platforms used across industries are characterized by vendor-specific offerings lacking interoperability, e.g. between different ESBs. 
     	Although Web Service and REST technologies are widely accepted, they are neither sufficient to build a SOA nor to ensure interoperability 
     	...
     	<p>With Eclipse SOA Tooling Platform (STP) and Eclipse SOA Runtime (Swordfish) key technologies are available for design time and runtime 
     	that have the potential to establish a common SOA platform. Moreover, the Eclipse Ecosystem assembles all major vendors of Java-based SOA platforms 
     	necessary to establish such a common SOA platform.  
     	</p>
     	...
     	<ol>
			...
			<li>It will develop a consistent communication and promotion program to help raise the awareness of the Eclipse SOA platform in the software industry. The promotion program includes:
				<ol>
					<li>The establishment of a brand including logo (see a draft in the attachment), which can be used for marketing purposes under certain rules. The rules will be governed in the Eclipse SOA Initiative as well.</li>
					<li>The promotion of products and services of its members around the Eclipse SOA platform on the website of the Eclipse SOA Initiative.</li>					
				</ol>
			 </li>
			 <li>It will define measurable criteria that allow interested parties outside the Eclipse SOA Initiative to benefit from their commitment to the Eclipse SOA platform. The fulfilment of these criteria needs to be approved by the Steering Committee. Currently, four distinct groups of parties have been identified that should be addressed by such a program. The program does include a listing on the website of the Eclipse SOA Initiative:
				<ol>
					...
					<li>Industry Working Group Members: Members of the Eclipse SOA Initiative contributing to the Eclipse SOA platform will be eligible to use the "Eclipse SOA Member" logo.</li>
				</ol>
			 </li>
		</ol>
		</p>
		
		<p>Note, that membership in the Eclipse SOA Initiative is not a prerequisite for the product vendors, add-in vendors and system integrators.  
