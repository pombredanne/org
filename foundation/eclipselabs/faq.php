...
<ol>
	...
	<p>Eclipse Labs is a community of open source projects that build technology based on the Eclipse platform.   It provides the services 
	...
	Eclipse Foundation and the projects do not have to follow the Eclipse development and intellectual property policies. </p>

	<p>There are a number of things Eclipse Labs projects can not do since they are not official Eclipse Foundation projects, 
	...
	<ul><li> generally get more exposure with the Eclipse community through things like eclipse.org web site, newsgroupgs, Eclipse conferences, etc.   This may make it easy for you to build a community of users and contributors.
	<li>officially recognized as an Eclipse project, so you can use the org.eclipse namespace and use Eclipse in your project name.   This strong association with the Eclipse brand maybe important to some organizations and individuals.
	<li>can be included in the annual Eclipse release train.  As a result, it can be included in any of the packages that are visible on the eclipse.org download page.  This will expand the distribution and potential user community for your project.
	<li>will undergo the Eclipse IP due diligence process, an important check for some downstream consumers of open source technology.
	</ul></p>
	...
	<li>the project is targeted as a small niche and might not benefit from the wider exposure of being an Eclipse Foundation project.
	</ul></p></li>
	...
	Eclipse Foundation.  If you believe at one time you will want to move you project to the Eclipse Foundation we suggest you ensure 
	that 1) you keep track of all contributions and ensure they are contributed under the EPL. You might consider having your committers 
	sign a version of the Eclipse sign a committer agreement [link to a template agreement] 2) do not include or link to any code that is 
	...
	<p>Google Code Project Hosting only provide support for Subversion and Mercurial.  Eclipse Labs is built upon Google Code Project Hosting
	 so we use the code managements systems.</p></li>
