...
function switchMenu(obj) {
	...
	<div id="midcolumn">
		...
		<p>
			The following is a list of nominations submitted for the Individual Awards.  Nominations close on January 28, 2011 and voting will take place January 31, 2011 - February 25, 2011.  Winners will be announced March 21 at <a href="http://www.eclipsecon.org">EclipseCon 2011</a>.
		</p>
		
		<h3>Top Committer</h3>

		<p><a href="javascript:switchMenu('CommitterName');" title="Description">
		<img src="http://www.eclipse.org/newsgroups/images/plus.gif" alt="Description" title="Description">
			Your Committer Nomination</a>
		</p>
		<div id="CommitterName" class="switchcontent">
		<p>
		<ul>
			<li>
			Comment
