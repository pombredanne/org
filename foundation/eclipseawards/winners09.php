	...
	<div id="midcolumn">
		...
		<div class="homeitem3col">
			...
			<ul>
				...
				<li class="winner">Paul Webster</li>					
			</ul>
		</div>
		...
		<div class="homeitem3col">
			...
			<ul>
				<li class="winner">Benjamin Cabe</li>
	...
	<h2><br>Technology Award Winners</h2>
		...
		<h3>Best Commerical Eclipse-Based Developer Tool</h3>
			<ul>
				...
				<li class="winner"><a href="http://www.instantiations.com/windowbuilder/index.html?id=1" target="blank">Instantiations WindowBuilder Pro</a></li>
			</ul>
		</div>	
		...
		<div class="homeitem3col">
			...
			<ul>
				<li class="winner"><a href="http://www.acceleo.org" target="blank">Acceleo</a></li>
		...
		<h3>Best Commercial Equinox Application</h3>
			<ul>
				...
				<li class="winner"><a href="http://www.prosyst.com/products/osgi_ext_smart.html" target="blank">ProSyst mBedded Server Smart Home Extension</a></li>
		...
		<h3>Best Open Source Equinox Application</h3>
			<ul>
				<li class="winner"><a href="http://www.modulefusion.org" target="blank">ModuleFusion</a></li>
		...
		<div class="homeitem3col">
			...
			<ul>
				<li class="winner"><a href="http://www.pluck-n-play.com" target="blank">Chord Scale Generator</a></li>
		...
		<div class="homeitem3col">
			...
			<ul>
				<li class="winner"><a href="http://directory.apache.org/studio" target="blank">Apache Directory Studio</a></li>
